// use crate::query;
// use crate::query::{DenseIter, QueryBase, QueryFilter, QueryModifier,
// SparseIter}; use crate::storage::Entity;
...
//             unsafe { Self::Dense(DenseIter::new_unchecked(iter_data, data,
// filter)) }         } else {
...
//                     unsafe {
//                         iter_data.entities =
// iter_data.entities.get_unchecked(range);
// Self::Dense(DenseIter::new_unchecked(iter_data, data, filter))
// }                 }
//                 Err(_) => {
//                     let (mut iter_data, sparse, data) = base.split_sparse();
//                     let (include_entities, include) =
// include.split_modifier();                     let (_, exclude) =
// exclude.split_modifier();
